...
<table class="table">
  ...
  <tbody>
        ...
        if( $_SESSION['team_id']){
            ...
            rescue_team_tasks.task_help_code, rescue_team_tasks.rescue_team_id, rescue_team_tasks.team_status, success_list.student_helpcode, success_list.incident_description
             FROM (((request_status
