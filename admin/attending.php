...
<table class="table" style='color:black; font-weight:normal'>
    ...
    if($_SESSION['admin_id']){
        ...
        FROM request_status
        INNER JOIN student_details ON request_status.admNo = student_details.regNum  WHERE request_status.status ='Responding' order by request_status.timestamp DESC;";
